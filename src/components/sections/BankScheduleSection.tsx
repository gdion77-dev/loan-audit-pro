...
export const BankScheduleSection: React.FC<BankScheduleSectionProps> = ({
  ...
  <section className="lap-card" aria-label={def.title}>
    ...
    <p className="lap-field-help" style={{ marginTop: '6px' }}>
      Η «σύμβαση ημερομέτρησης» είναι ο κανόνας με τον οποίο μετρώνται οι ημέρες για τον
      υπολογισμό των τόκων (τόκος ≈ κεφάλαιο × επιτόκιο × ημέρες περιόδου ÷ ημέρες έτους).
      Συνήθως αναγράφεται στον όρο της σύμβασης περί υπολογισμού τόκων:
    </p>
    <p className="lap-field-help">
      <strong>ACT/365:</strong> πραγματικές ημέρες, έτος 365 (συχνό σε ελληνικά στεγαστικά).{' '}
      <strong>ACT/360:</strong> πραγματικές ημέρες, έτος 360 (συχνό σε εμπορικά/επιχειρηματικά·
      δίνει ελαφρώς υψηλότερο τόκο). <strong>30/360:</strong> κάθε μήνας 30 ημέρες, έτος 360.{' '}
      <strong>ACT/ACT:</strong> πραγματικές ημέρες και στον αριθμητή και στον παρονομαστή. Αν η
      σύμβαση λέει «έτος 360 ημερών» → ACT/360· αν «365 ημερών» → ACT/365.
    </p>
